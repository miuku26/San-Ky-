document.addEventListener('DOMContentLoaded', () => {
    ...
    const timeline1975 =
        document.querySelector('#timeline1975');

    if (timeline1975) {
        timeline1975.addEventListener(
            'click',
            () => {
                timeline1975.dispatchEvent(
                    new CustomEvent(
                        'openTimeline',
                        {
                            bubbles: true,
...
const timeline1975 =
    document.getElementById('timeline1975');

if (timeline1975) {

    timeline1975.addEventListener('click', () => {

        timeline1975.classList.add('is-opening');
