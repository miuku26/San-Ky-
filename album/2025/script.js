document.addEventListener('DOMContentLoaded', () => {
    ...
    const timeline2025 =
        document.querySelector('#timeline2025');

    if (timeline2025) {
        timeline2025.addEventListener(
            'click',
            () => {
                timeline2025.dispatchEvent(
                    new CustomEvent(
                        'openTimeline',
                        {
                            bubbles: true,
...
const timeline2025 =
    document.getElementById('timeline2025');

if (timeline2025) {

    timeline2025.addEventListener('click', () => {

        timeline2025.classList.add('is-opening');
